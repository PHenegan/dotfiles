...

{
  ...
  boot.plymouth.themePackages = with pkgs; [ plymouth-blahaj-theme ];
  boot.plymouth.theme = "blahaj";

  # Use latest kernel.
  boot.kernelPackages = pkgs.linuxPackages_latest;

  networking.hostName = "porygon2"; # Define your hostname.
